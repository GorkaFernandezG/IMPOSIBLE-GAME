...
EGOERA JOKOA_egoera_3(JOKO_ELEMENTUA jokalaria, JOKO_ELEMENTUA oztopoa1, JOKO_ELEMENTUA oztopoa2, JOKO_ELEMENTUA oztopoa3,  int dauka) {
    EGOERA  ret = JOLASTEN;
    if ((jokalaria.pos.x > oztopoa1.pos.x - 20 && jokalaria.pos.x <oztopoa1.pos.x + 20 && jokalaria.pos.y >oztopoa1.pos.y - 20 && jokalaria.pos.y < oztopoa1.pos.y + 20) || (jokalaria.pos.x > oztopoa2.pos.x - 20 && jokalaria.pos.x <oztopoa2.pos.x + 20 && jokalaria.pos.y >oztopoa2.pos.y - 20 && jokalaria.pos.y < oztopoa2.pos.y + 20) || (jokalaria.pos.x > oztopoa3.pos.x - 15 && jokalaria.pos.x <oztopoa3.pos.x + 15 && jokalaria.pos.y >oztopoa3.pos.y - 15 && jokalaria.pos.y < oztopoa3.pos.y + 15))
    {
        ret = GALDU;
    }
